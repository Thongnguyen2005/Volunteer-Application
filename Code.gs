...
function sendReminderEmails(foResponse) {

  const responseData = foResponse.getItemResponses();
  ...
  const email = foResponse.getRespondentEmail(); // Assuming you collect email addresses in your form
